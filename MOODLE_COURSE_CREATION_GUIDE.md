...
1. [Importing a Course via Web Interface](#importing-a-course-via-web-interface)
2. [Moodle Database Architecture](#moodle-database-architecture)
3. [Course Creation Workflow](#course-creation-workflow)
4. [Question Bank Management](#question-bank-management)
5. [Quiz Creation (The Correct Way)](#quiz-creation-the-correct-way)
6. [Cognitive Science Principles](#cognitive-science-principles)
...
## Importing a Course via Web Interface

This section covers the standard method for importing a Moodle course backup (.mbz file) into your Moodle site using the web interface. This is the recommended approach for most users.
